...
*   **The Opening (The Hook):** Start with a surprising fact, a brief story, or a strong statement to grab attention. Tell them *why* they should care.
*   **The Body (The Rule of 3):** Humans remember things in threes. Break your main point into exactly three sub-points.
*   **The Closing (The Call to Action):** Summarize briefly and end with a clear, memorable final thought. 
...
*   **Plant Your Feet:** Avoid shifting your weight or pacing aimlessly. Stand tall and grounded.
*   **Eye Contact:** Do not stare at your slides. Speak *to* your audience. Make 3 seconds of eye contact with one person, then move to another.
*   **Use the Pause:** Silence is powerful. Pause for 2 seconds after a major point to let it sink in.
...
It is your turn to take the stage.

1.  **Preparation:** You have 5 minutes to outline a presentation on a topic provided by your instructor. 
2.  **Execution:** Deliver a strict 2-3 minute micro-presentation to your pod.
3.  **Feedback:** Your pod members will evaluate your structure and delivery.
